...
export function dayView(state,day,totals) {
  ...
  return {version:1,requireParentModeForCompletion:!!state.requireParentModeForCompletion,dayScoped:true,day,updatedAt:state.updatedAt,familyName:state.familyName,pin:state.pin,setupDone:state.setupDone,
