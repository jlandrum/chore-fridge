...
- A Currency settings page with built-in credits that can be turned on and renamed: Star and Gold Star (on by default), plus Coin, Dollar, Hours, Custom 1, and Custom 2. Built-in marks are SVG icons; Gold Star shimmers. Custom 1 and Custom 2 pick an emoji. Internal identifiers do not change.
