...
- The add/edit task sheet keeps labels above the fields instead of overlapping them, puts the task name and emoji on one row, lays frequency out in three columns, explains counted tasks as “at least / up to”, uses a gold-star switch, and keeps Cancel and Save visible while the fields scroll.
