...
- Settings now opens as a modal over the board with accessible tab navigation, an explicit Close button, and display preferences embedded in the Display tab. The original theme is labeled Classic (V1).
